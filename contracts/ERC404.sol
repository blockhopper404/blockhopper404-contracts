...
abstract contract ERC404 is IERC404 {
  ...
  function erc721Approve(address spender_, uint256 id_) public virtual {
    ...
    emit ERC721Events.ERC721Approval(erc721Owner, spender_, id_);
  }
  ...
  function erc20Approve(
    ...
    emit ERC20Events.ERC20Approval(msg.sender, spender_, value_);
  ...
  function _isValidTokenId(uint256 id_) internal view returns (bool) {
    return id_ > 0 && id_ <= minted && id_ != type(uint256).max;
  }
  ...
  function _transferERC20(
    ...
    emit ERC20Events.ERC20Transfer(from_, to_, value_);
  }
